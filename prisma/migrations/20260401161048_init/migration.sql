...
-- CreateIndex
CREATE UNIQUE INDEX "categories_projectId_name_key" ON "categories"("projectId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "task_categories_taskId_categoryId_key" ON "task_categories"("taskId", "categoryId");
